    ...
    <div class="orders">
        <div class="breadcrumbs-fixed col-md-offset-2 panel-action padding-left-10">
            <h5 style="float: left;">
                ...
                <label style="color: #307ecc;">
                    <input type="radio" name="profit" id="profit-sale" value="3" checked>
                    ...
                    <tbody>
                        @if(!empty($orderByEmp) && count($orderByEmp) > 0)
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ $value['employee']->total_origin_price ? number_format($value['employee']->total_origin_price) : 0 }}</td>
                                <td class="text-center">{{ $value['employee']->total_money && $value['employee']->total_origin_price ? number_format($value['employee']->total_money - $value['employee']->total_origin_price) : 0 }}</td>
                            </tr>
                                                ...
                                                <table class="table table-striped table-bordered table-hover dataTable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center"
                                                                style="background: #fff;">{{ $item['total_origin_price'] ? number_format($item['total_origin_price']) : 0 }}</td>
                                                            <td class="text-center"
                                                                style="background: #fff;">{{ $item['total_money'] && $item['total_origin_price'] ? number_format($item['total_money'] - $item['total_origin_price']) : 0 }}</td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
