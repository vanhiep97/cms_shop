                    ...
                    <div class="products-act">
                        <div class="col-md-4 col-md-offset-2">
                            <div class="left-action text-left clearfix">
                                <h2><i class="fa fa-refresh fa-fw" style="font-size: 14px; cursor: pointer;"></i> Cập nhật
                                    sản
                                    phẩm</h2>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="right-action text-right">
                                <div class="btn-groups">
                                    <button type="submit" id="btn-save" value="update-product" data-id="{{ $product->id }}" class="btn btn-primary"><i
                                            class="fa fa-check"></i> Lưu
                                    </button>
                                    <button type="submit" id="btn-save-continue" value="update-product" data-id="{{ $product->id }}" class="btn btn-primary"><i
                                ...
                                <div class="row">
                                    <div class="form-group clearfix">
                                        <div class="col-md-12 padd-left-0 padd-right-0">
                                            ...
                                            <input type="text" name="product_name" value="{{ old('product_name', $product->product_name) }}" id="product_name"
                                                   class="form-control"
                                    ...
                                    <div class="form-group clearfix">
                                        <div class="col-md-6 padd-left-0">
                                            ...
                                            <input type="text" name="product_code" value="{{ old('product_code', $product->product_code) }}" id="product_code" class="form-control "
