                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <div class="form-group clearfix">
                                        <div class="col-md-6 padd-left-0">
                                            <label>Giá vốn</label>
                                            <input type="text" name="product_origin_price" id="product_origin_price"
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="col-md-6 padd-right-0">
                                            ...
                                            <div class="col-md-11 padd-0">
                                                <select class="form-control" name="product_manufacture_id" id="product_manufacture_id">
                                                    <optgroup label="Chọn nhà sản xuất">
                                                        @if($manufactures && count($manufactures) > 0)
                                                            @foreach($manufactures as $key => $value)
                                                                <option
                                                                    value="{{ $value->id }}">{{ $value->manufacture_name }}</option>
                                                            @endforeach
                                                        @endif
                                                    </optgroup>
                                                </select>
                            ...
                            <div class="collapse" id="collapseproductinfo">
                                ...
                                <div class="col-md-12">
                                    <div class="btn-groups pull-right" style="margin-top: 15px;">
                                        ...
                                        <button id="btn-save-continue" type="submit" class="btn btn-primary "><i
                                                class="fa fa-floppy-o"></i>
                                            Lưu và tiếp tục
                                        </button>
                                        <a href="{{ URL::previous() }}" class="btn btn-default btn-back"><i
                                                class="fa fa-arrow-left"></i> Trở về
                                        </a>
                                    </div>
                                </div>
