            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 padd-0">
                        <button class="btn btn-primary" id="btn-changepass"><i class="fa fa-retweet"></i> Đổi mật khẩu
                        </button>
                        <div class="form-hide form-change-password" style="display: none;">
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="label label-danger arrowed-right" style="display: none;"
                                          id="newpass-wrong">
                                ...
                                <div class="form-group">
                                    <button type="reset" class="btn btn-default btn-sm" id="btn-cancel-pass">Hủy
                                    </button>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <?php echo '<span class="user_group" style="display: inline-block; color: #fff; background: #428BCA; padding: 2px 5px;"><i class="fa fa-male"></i> ' .'sdsdsd' . '</span>'; ?>
                    </div>
                </div>
            </div>
        </div>
