        ...
        <div class="breadcrumbs-fixed col-md-offset-2 panel-action padding-left-10">
            <h5 style="float: left;">
                ...
                <label style="color: #307ecc;">
                    <input type="radio" name="revenue" id="revenue-customer" value="2" checked>
                            ...
                            <div class="report-box" style="border: 1px dotted #ddd; border-radius: 0">
                                ...
                                <div class="infobox-data">
                                    ...
                                    <h3 class="infobox-title cgreen"
                                        style="font-size: 25px;">{{ ($customers ? count($customers) : 0). '/' .($totalProductOnOrder ? $totalProductOnOrder : 0)}}</h3>
                                            ...
                                            <div class="tab-pane active">
                                                <table class="table table-striped table-bordered table-hover dataTable">
                                                    ...
                                                    <tr role="row">
                                                        ...
                                                        <th class="text-center ">Tổng tiền</th>
                                                        <th class="text-center ">Hoàn trả khách</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
