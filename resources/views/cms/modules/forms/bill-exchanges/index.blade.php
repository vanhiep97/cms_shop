                    ...
                    <div class="col-md-6">
                        ...
                        <div class="right-action text-right">
                            <div class="btn-groups">
                                <a href="{{ route('forms.createBillExchange') }}" class="btn btn-primary"><i
                                        class="fa fa-plus"></i> Tạo phiếu đổi trả
                                </a>
                            </div>
                        </div>
                        @endif
        ...
        <div class="orders-content">
            <div class="product-sear panel-sear">
                <div class="form-group col-md-3 padd-0">
                    <input type="text" class="form-control" id="bill-exchange-search-code"
                ...
                <div class="form-group col-md-9 padd-0" style="padding-left: 5px;">
                    <div class="col-md-9 padd-0">
                        ...
                        <div class="col-md-5 padd-0" style="padding-left: 5px;">
                            <button style="box-shadow: none;" id="btn-search-bill-exchange" type="button" class="btn btn-primary btn-large"><i
            ...
            <div class="delete-multi" style="margin-bottom: 10px">
                <button type="button" id="delete-multi-exchange" class="btn btn-danger btn-large btn-ssup"><i
                        class="fa fa-trash-o"></i> Xóa nhiều
                </button>
            </div>
            @endif
            <div class="imports-main-body" id="list-bill-exchanges">
                @include('cms.modules.forms.bill-exchanges.list_bill')
            </div>
        </div>
    </div>
@endsection
